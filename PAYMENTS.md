# PAYMENTS.md — MoveInReport monetization setup (Allen's ~5-minute step)
...
The full workbook is served from `/full/MoveInReport.xlsx` (blocked in robots.txt but technically a public URL — a buyer could share the direct link). Fine for $12.99-at-this-scale. When sales justify it (say 20+/mo):
1. Create Gumroad/LemonSqueezy product "MoveInReport $12.99" with the xlsx as auto-delivered content.
...
## 4. Pricing rationale
$12.99 ≈ $2.60 — deep impulse zone for a store owner, above the ₱99 "walang kwenta" floor, 10x+ cheaper than POS subscriptions. The demo does the selling: dashboard + alerts visible in 30 seconds of use.
